...
class Block(pygame.sprite.Sprite):
    def __init__(self, start, head=False, color= GREEN2 ):
        super().__init__()
...
class main():
    def __init__(self, velocitat, normal):
        all_sprites.empty()
        obstacles.empty()
        obs = Obstacles()
        window = view_snake.Window(WIN_WIDTH, WIN_HEIGHT)
        head = pygame.image.load("SnakeHeadGreen.png")
